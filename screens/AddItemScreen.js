...
import { View, Text, TouchableOpacity, StyleSheet, KeyboardAvoidingView, TextInput, Picker } from 'react-native';
...
export default class AddItemScreen extends React.Component {
    ...
    constructor(props) {
        super(props);
        console.log('data params add item', this.props.navigation.state)
        this.state = {
            image: null,
            name: '',
            price: '',
    ...
    async addItem() {
        ...
        //         console.log('item id please ', collection.id);
        ...
        return (
            ...
            <KeyboardAvoidingView style={styles.container}
                ...
                <ScrollView>
                    ...
                    <View style={{ height: 60, backgroundColor: 'gray', marginBottom: 10, width: '66%', alignSelf: 'center', borderBottomWidth: 2, borderRightWidth: 2, borderColor: 'lightgrey' }}>
                    ...
                    <View style={{ height: 90, backgroundColor: 'gray', marginBottom: 10, width: '66%', alignSelf: 'center', borderBottomWidth: 2, borderRightWidth: 2, borderColor: 'lightgrey' }}>
                        <TextInput multiline style={styles.inputText}
